...
class _RequestBloodPageState extends State<RequestBlood> {
  ...
  final _madicalCenterNameController = TextEditingController();
  ...
  String _cityNameEmpty = "Please enter address";
  String _numberOfUnitsEmpty = "Please enter number of units";
  ...
  void dispose() {
    ...
    _madicalCenterNameController.dispose();
    super.dispose();
  }
                      ...
                      children: <Widget>[
                        ...
                        FadeAnimation(
                          ...
                          InkWell(
                              ...
                              onTap: () {
                                if (_patientNameController.text.trim() ==
                                    null) {
                                  showtoast(_patientNameEmpty);
                                } else if (_contactNumberController.text
                                        .trim() ==
                                    null) {
                                  showtoast(_contactNumberEmpty);
                                } else if (_cityNameController.text.trim() ==
                                    null) {
                                  showtoast(_cityNameEmpty);
                                } else if (_numberOfUnitsController.text
                                        .trim() ==
                                    null) {
                                  showtoast(_numberOfUnitsEmpty);
    ...
    if (_formKey.currentState.validate()) {
      try {
        ...
        await requests.add({
          ...
          'medicalCenterName': _madicalCenterNameController.text,
  ...
  Widget _cityNameField() => TextFormField(
  ...
  Widget _medicalCenterNameField() => TextFormField(
        controller: _madicalCenterNameController,
        keyboardType: TextInputType.text,
        textInputAction: TextInputAction.next,
        textCapitalization: TextCapitalization.words,
        validator: (v) => Validators.required(v, 'Medical Center name'),
        decoration: InputDecoration(
          labelText: 'Medical Center Name',
          fillColor: Colors.white,
          // border: OutlineInputBorder(),
        ),
        style: TextStyle(
  ...
  Widget _numberOfUnitsField() => TextFormField(
        controller: _numberOfUnitsController,
        keyboardType: TextInputType.number,
        textInputAction: TextInputAction.next,
        validator: (v) =>
            Validators.required(v, 'number of units') ?? Validators.phone(v),
        decoration: const InputDecoration(
  ...
  void _resetFields() {
    ...
    _madicalCenterNameController.clear();
    setState(() {
      _requestDate = null;
    });
  }
